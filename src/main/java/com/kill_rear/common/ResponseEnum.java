...
public enum ResponseEnum {
    ...
    IllEGAL_DATA(20002, "数据非法"),
    DELETE_FIALED(30000, "删除失败，班级学生人数不为0"),
    SELECT_FIALED(30001, "选课失败"),
    SELECT_TWICE(30002,"重复选课"),
    SELECT_NO_POSITION(30003,"选课已满"),
    SELECT_SUCCESS(30004,"选课成功"),
    SELECT_TIME_FAILED(30005,"时间重叠")
    ;
    Integer code;		//响应码
    String message;		//响应信息
